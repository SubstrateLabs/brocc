...
<MdxAccordionGroup defaultValue="how-it-works">
<MdxAccordionItem title="How it works" value="how-it-works">

</MdxAccordionItem>

<MdxAccordionItem title="System design" value="system-design">
